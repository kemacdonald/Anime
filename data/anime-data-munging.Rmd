...
anime.a.ichart$Condition <- recode(anime.a.ichart$Condition, 
         vanilla = "name_familiar", sounds = "onomatopoeic_word_familiar",
         NF = "name_novel", FN = "name_familiar")

# anime_b (vocalization trials)
anime.b.ichart$Condition <- recode(anime.b.ichart$Condition, 
         FF = "vocalization_familiar", FN = "vocalization_familiar",
         NF = "vocalization_novel")

# anime_c (retention of names and lexicalized animal sounds)
anime.c.ichart$Condition <- recode(anime.c.ichart$Condition, 
         FF = "vocalization_familiar", FN = "vocalization_familiar",
         NF = "vocalization_novel", NT = "vocalization_retention_novel")
```
...
cdi_df <- bind_rows(anime_cdi, animoo_cdi) %>% 
  ...
  filter(duplicated(Sub.Num) == FALSE) # REMOVE ANY DUPLICATES
```
