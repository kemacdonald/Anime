...
group_means_plot <- d_ss %>% 
  ...
  geom_line(aes(group = 1), data = e1_model_summary, color = "darkorange", size = 1,
            position = position_nudge(x = 0.4)) + 
  geom_pointrange(data = e1_model_summary, aes(ymin = hdi_lower, ymax = hdi_upper),
                  color = "darkorange", fill = "darkorange", shape=21, size = 0.5,
                  position = position_nudge(x = 0.4)) + 
