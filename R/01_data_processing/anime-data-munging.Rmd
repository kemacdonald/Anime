...
```{r read iCharts}
anime.a.ichart <- readiChart("../../01_data/raw_data/ANIME_A_iChart.txt") 
anime.b.ichart <- readiChart("../../01_data/raw_data/ANIME_B_iChart.txt")
anime.c.ichart <- readiChart("../../01_data/raw_data/ANIME_retention_iChart.txt")
```
...
```{r write data}
write_csv(ichart.final, "../../data/02_tidy_data/anime_tidy_ichart.csv")
